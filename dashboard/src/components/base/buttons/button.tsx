/**
 * Clone path: `components/base/buttons/button.tsx`, unchanged.
 */
...
export const styles = sortCx({
  common: {
    root: [
      'group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-focus-ring transition-colors duration-150 ease-out before:absolute focus-visible:outline-2 focus-visible:outline-offset-2',
  ...
  sizes: {
    xs: {
      root: [
        'gap-1 rounded-lg px-2.5 py-1.5 text-sm font-medium before:rounded-[7px] data-icon-only:p-2',
    ...
    sm: {
      root: [
        'gap-1 rounded-lg px-3 py-2 text-sm font-medium before:rounded-[7px] data-icon-only:p-2',
        'in-data-input-wrapper:px-3.5 in-data-input-wrapper:py-2.5 in-data-input-wrapper:data-icon-only:p-2.5',
      ].join(' '),
      linkRoot: 'gap-1 *:data-text:underline-offset-3',
    },
    md: {
      root: [
        'gap-2 h-10 rounded-lg px-3 py-2 text-sm font-medium before:rounded-[7px] data-icon-only:p-2.5',
        'in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3',
      ].join(' '),
      linkRoot: 'gap-1 *:data-text:underline-offset-4',
    },
    lg: {
      root: 'gap-1.5 rounded-lg px-4 py-2.5 text-md font-medium before:rounded-[7px] data-icon-only:p-3',
      linkRoot: 'gap-1.5 *:data-text:underline-offset-4',
    },
    xl: {
      root: 'gap-1.5 rounded-lg px-4.5 py-3 text-md font-medium before:rounded-[7px] data-icon-only:p-3.5',
      linkRoot: 'gap-1.5 *:data-text:underline-offset-4',
    },
  },
  ...
  colors: {
    ...
    'secondary-destructive': {
      root: [
        'bg-primary text-secondary ring-1 ring-primary outline-focus-ring ring-inset hover:bg-error-primary hover:text-error-primary_hover data-loading:bg-error-primary',
        // Icon styles
        '*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-error-primary',
      ].join(' '),
    },
